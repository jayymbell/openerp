...
class ProductAssembliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_assembly" do
    assert_difference('ProductAssembly.count') do
      post product_assemblies_url, params: { product_assembly: { description: @product_assembly.description, is_active: @product_assembly.is_active, name: @product_assembly.name, product_id: @product_assembly.product_id } }
    end
  ...
  test "should update product_assembly" do
    patch product_assembly_url(@product_assembly), params: { product_assembly: { description: @product_assembly.description, is_active: @product_assembly.is_active, name: @product_assembly.name, product_id: @product_assembly.product_id } }
