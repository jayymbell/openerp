...
class PurchaseOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post purchase_orders_url, params: { purchase_order: { customer_id: @purchase_order.customer_id } }
    end
  ...
  test "should update purchase_order" do
    patch purchase_order_url(@purchase_order), params: { purchase_order: { customer_id: @purchase_order.customer_id } }
