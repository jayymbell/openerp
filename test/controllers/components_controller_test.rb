...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { cost: @component.cost, description: @component.description, is_active: @component.is_active, name: @component.name, quantity: @component.quantity } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { cost: @component.cost, description: @component.description, is_active: @component.is_active, name: @component.name, quantity: @component.quantity } }
