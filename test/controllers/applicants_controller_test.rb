...
class ApplicantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create applicant" do
    assert_difference('Applicant.count') do
      post applicants_url, params: { applicant: { is_active: @applicant.is_active, person_id: @applicant.person_id } }
    end
  ...
  test "should update applicant" do
    patch applicant_url(@applicant), params: { applicant: { is_active: @applicant.is_active, person_id: @applicant.person_id } }
