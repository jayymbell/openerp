...
class WorkflowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workflow" do
    assert_difference('Workflow.count') do
      post workflows_url, params: { workflow: { category: @workflow.category, description: @workflow.description, is_active: @workflow.is_active, name: @workflow.name } }
    end
  ...
  test "should update workflow" do
    patch workflow_url(@workflow), params: { workflow: { category: @workflow.category, description: @workflow.description, is_active: @workflow.is_active, name: @workflow.name } }
